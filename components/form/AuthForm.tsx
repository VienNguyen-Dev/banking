    ...
    <section className="auth-form">
      <header className=" flex flex-col gap-5 mb-8">
        ...
        <div className=" flex flex-col gap-2 md:gap-3">
          <h1 className=" font-semibold text-24 lg:text-36">{user ? " Link Account" : type === "sign-in" ? "Sign In" : "Sign Up"}</h1>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              {type === "sign-up" && (
                <>
                  ...
                  <CustomInput name="city" placeholder="Example: Ho Chi Minh" control={form.control} label="City" />
                  <div className="flex gap-4">
                    <CustomInput name="state" placeholder="Example: Q1" control={form.control} label="State" />
                    <CustomInput name="postalCode" placeholder="Example: 700000" control={form.control} label="Postal Code" />
                  </div>
                  <div className="flex gap-4">
                    <CustomInput name="dateOfBirth" placeholder="DD-MM-YYYY" control={form.control} label="Date of Birth" />
